...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions.append(Transaction(self.index,self.balance,self.balance+amount))
        self.index+=1
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.index,self.balance,self.balance))
            self.index+=1
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        extra_age=Mint.present_year-self.year-50
        if extra_age>0:
            return self.cents+extra_age
        return self.cents
